        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl relative z-10">
          ...
          <div className="flex items-center justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-10 py-4 text-lg font-bold text-white bg-[#06C755] hover:bg-[#05b54d] rounded-full transition-all duration-300 shadow-lg shadow-green-500/30"
            >
