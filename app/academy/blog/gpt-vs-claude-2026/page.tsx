...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "長い仕様書や議事録を一度に扱う前提なら、公開仕様上は400,000 tokensのGPT-5.2が選びやすいです。ただし実務では入力分割や要約前処理でも品質差は埋まるため、実際のドキュメント長で検証して決めるのが確実です。",
  },
  {
    question: "チームで導入する際に最初に決めるべき運用ルールは何ですか？",
    answer:
      "プロンプトテンプレートの共通化、出力レビュー基準、機密情報の入力制限の3点を先に定義すると品質が安定します。個人判断で使い始めると、文体や根拠水準がばらつき、後から統一コストが大きくなります。",
  },
] as const;
