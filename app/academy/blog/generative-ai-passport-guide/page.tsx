...
const pageTitle = "生成AIパスポート試験の合格法2026｜勉強時間・おすすめ教材・出題傾向まとめ | AIリブート";
const pageDescription =
  "生成AIパスポート試験の合格法を2026年版で解説。難易度・合格率・費用、勉強時間の目安（20/30/40時間）、独学向け教材、頻出テーマ、合格後の活かし方まで1ページで整理します。";
