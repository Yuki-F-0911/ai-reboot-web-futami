...
const metiReskillingComparisonTitle = "経産省のリスキリング支援制度対象講座を比較する視点｜選び方のポイント";
const metiReskillingComparisonDescription =
  "経産省のリスキリング支援制度の対象講座を検討する方向けに、制度対象の意味、選定基準、チェックリスト、確認ポイントを整理。制度理解と講座選びを両立する比較ガイドです。";
...
const metiReskillingComparisonFaqItems = [
  {
    question: "制度対象の講座なら、どれを選んでも同じですか？",
    answer:
      "制度対象であることは一定要件を満たす目安ですが、成果までを保証するものではありません。実践課題、サポート体制、受講目的との一致をあわせて確認することが重要です。",
  },
  {
    question: "制度対象かどうかはどこで確認できますか？",
    answer:
  ...
  },
  {
    ...
    answer:
      "制度要件の確認に加えて、講座実績、実践課題の有無、サポート運用の具体性を重視してください。制度要件と実務成果の両方を見て判断できます。",
  },
  {
