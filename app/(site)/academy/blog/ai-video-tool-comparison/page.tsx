...
const faqItems = [
  ...
  {
    question: "生成AIだけで完成動画まで作るのは現実的ですか？",
    answer:
      "短尺の試作なら可能ですが、実務では字幕・テンポ・縦型最適化・音量調整まで必要になるため編集AIの併用が現実的です。生成は素材作成、編集は仕上げと分業した方が品質と納期を両立しやすくなります。",
  },
  {
    question: "プロンプト管理はどうすれば再現性が上がりますか？",
    answer:
      "用途、尺、縦横比、カメラ指示、NG要素をテンプレ化して案件ごとに保存してください。同じ型で比較生成すると修正工数が減り、複数人で運用しても品質を揃えやすくなります。",
  },
] as const;
