...
const faqItems = [
  ...
  {
    question: "転職や社内評価で先に効きやすいのはG検定とE検定のどちらですか？",
    answer:
      "非エンジニア職や企画職では、まずG検定でAIリテラシーを示すほうが評価につながりやすいです。エンジニア職で深層学習の実装力を問われる場合はE検定の専門性が効くため、職種要件に合わせて優先順位を決めるのが合理的です。",
  },
  {
    question: "独学で学ぶ場合、教材はどう選べば失敗しにくいですか？",
    answer:
      "出題範囲対応の公式系テキストを軸にしつつ、過去問形式の演習で理解を定着させる構成が安定します。E検定は前提数学の補強教材を最初に入れておくと、後半の深層学習パートで挫折しにくくなります。",
  },
] as const;
