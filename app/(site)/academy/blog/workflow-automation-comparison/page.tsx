...
const faqItems = [
  ...
  {
    question: "月間1,000件以上の処理がある場合、どのツールがコスト面で有利ですか？",
    answer:
      "同じ処理量でもZapierはタスク課金で費用が上がりやすく、Makeはオペレーション課金のため中規模運用で有利になることが多いです。機密要件を満たせるなら、n8nセルフホストに移行してインフラ費のみで運用する構成が最も安くなるケースもあります。",
  },
] as const;
