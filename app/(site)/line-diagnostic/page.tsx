...
import LineDiagnosticLP from "@/components/lp/LineDiagnosticLP";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/lp/line-diagnostic/hero.png",
        width: 1200,
        height: 630,
...
export default function LineDiagnosticPage() {
  return <LineDiagnosticLP />;
}
