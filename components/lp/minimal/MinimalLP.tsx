...
import styles from "./MinimalLP.module.css";

const LINE_SRC_PREFIX = "lp_minimal";
      ...
      <section className={styles.section}>
        <div className={styles.sectionInner}>
          ...
          >
            ...
            <motion.div variants={fadeIn} style={{ marginTop: 36 }}>
              <LineCTA
              ...
              {questions.map((q) => (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", color: "#6366f1" }}>{q.label}</span>
                  </div>
            ...
            <div className={styles.giftLayout}>
              ...
              <div className={styles.giftContent}>
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {gifts.map((gift) => (
                    <motion.div key={gift.title} variants={fadeIn} className={styles.card}>
                      <div className={styles.cardHorizontal}>
                ...
                <motion.div variants={fadeIn} style={{ marginTop: 24 }}>
                  <LineCTA
                    label="今すぐ無料診断を受ける"
                    className={styles.ctaButton}
    ...
    <>
      ...
      <section className={styles.sectionAlt}>
        <div className={styles.sectionInner}>
          ...
          >
            <motion.div variants={fadeIn}>
              <span className={styles.sectionLabel}>Supported Tools</span>
            </motion.div>
            <motion.h2 variants={fadeIn} className={styles.sectionTitle}>
              17種類以上のAIツールから
              <br />
            ...
            <motion.p
              variants={fadeIn}
              style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 14, color: "#6366f1", fontWeight: 600 }}
            >
      ...
      <section className={styles.section}>
        <div className={styles.sectionInner} style={{ maxWidth: 680 }}>
          ...
          >
            ...
            <motion.h2 variants={fadeIn} className={styles.sectionTitle} style={{ marginBottom: 32 }}>
              よくある質問
            </motion.h2>
    ...
    <section className={styles.finalCta}>
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          style={{ fontSize: 16, color: "#94a3b8", lineHeight: 1.8, marginBottom: 32 }}
        >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px 24px", marginBottom: 32 }}
        >
          {[
