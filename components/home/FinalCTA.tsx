          ...
          <Link href="/contact">
            <button className="group px-8 py-4 bg-gradient-to-r from-will-primary to-will-secondary text-white rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="flex items-center justify-center gap-3">
                <MessageCircle className="w-5 h-5 text-white transition-opacity group-hover:opacity-90" />
                <span className="text-white font-medium group-hover:opacity-90 transition-opacity">
                  お問い合わせ
                </span>
              </div>
            </button>
