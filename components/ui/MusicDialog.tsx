...
export default function MusicDialog({ onSettingComplete }: MusicDialogProps) {
  ...
  useEffect(() => {
    // 初回訪問チェック（SessionStorageを使用）
    const hasVisited = sessionStorage.getItem('hasVisited')
    if (!hasVisited) {
      setShowDialog(true)
    } else {
      // 既に訪問済みの場合は即座にコンテンツを表示
      onSettingComplete()
    }
            ...
            >
              ...
              <div className="relative bg-gradient-to-r from-will-primary to-will-secondary p-6">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/90 text-sm">AI REBOOTの世界観を音楽でも体験</p>
                </div>
              </div>
