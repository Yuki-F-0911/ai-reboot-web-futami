      ...
      <div className="container-section relative z-10 py-20">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* メインタイトル */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-depth-900 mb-6 leading-[1.2]">
              生成AI時代の
              <br />
              <span className="relative inline-block">
                新しい自分へ
                <span className="absolute bottom-2 left-0 w-full h-3 bg-will-primary/20 -z-10" />
              </span>
            </h1>
          ...
          >
            <Link href="#application">
              <button className="group relative px-10 py-4 bg-will-primary text-white font-medium rounded-lg hover:bg-will-primary/90 transition-all duration-200 min-w-[220px] shadow-lg shadow-will-primary/20">
                無料説明会に申し込む
                <span className="absolute -inset-0.5 bg-will-primary rounded-lg blur opacity-30 group-hover:opacity-50 transition-opacity" />
                <span className="relative">無料説明会に申し込む</span>
              </button>
            </Link>
