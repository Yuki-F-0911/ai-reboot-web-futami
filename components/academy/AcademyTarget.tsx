    ...
    <section className="section-spacing">
      <div className="container-section">
        ...
        >
          ...
          <div className="bg-white rounded-3xl p-10 md:p-14 shadow-lg border border-depth-100 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-will-primary/10 to-transparent rounded-full -translate-y-32 translate-x-32" />
            <div className="space-y-6">
              {targets.map((target, index) => (
                ...
                >
                  ...
                  <p className="text-lg text-depth-800 leading-relaxed py-1">
                    {target}
