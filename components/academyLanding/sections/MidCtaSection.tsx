import { ACADEMY_TYPOGRAPHY } from "./academyDesignTokens";
    ...
    return (
        ...
        >
            <div className="container mx-auto px-6 lg:px-12 max-w-4xl text-center">
                ...
                <h2 
                    className="text-3xl lg:text-4xl font-bold text-slate-900 leading-tight mb-8"
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                    ...
                    <a
                        ...
                        className="text-slate-900 font-bold border-b border-slate-900 pb-1 transition-opacity hover:opacity-70 group flex items-center gap-2"
                    >
