...
const selectionGuides = [
  {
    useCase: "SNS動画",
    recommendation: "KlingまたはSeedanceで素材を作り、編集ツールで仕上げる。",
    reason: "本数と再現性を優先するなら、素材分離が安定します。",
  },
  {
    useCase: "プレゼン動画",
    recommendation: "SoraまたはRunwayで必要カットを生成し、章立てに合わせる。",
    reason: "説明動画は情報伝達が優先なので、構図の安定を重視します。",
  },
  {
    useCase: "副業案件",
    recommendation: "Runwayの有料プランを基軸に、規約確認済みフローを固定する。",
    reason: "商用条件の明確さと修正速度を優先してください。",
  },
  {
    useCase: "個人制作",
    recommendation: "4ツールを短尺で試し、最も相性の良い1つへ集約する。",
    reason: "無料枠で相性確認を優先すると効率が上がります。",
  },
] as const;
