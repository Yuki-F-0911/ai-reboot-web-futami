...
const tocItems = [
  ...
  { id: "difference-gpt4o", label: "通常のChatGPT（GPT-5.2）との違い" },
    ...
    <main className="bg-white pb-20 pt-28 sm:pt-32">
      <article className="mx-auto max-w-5xl px-5 sm:px-6" data-blog-article-body>
        ...
        <motion.section
          ...
          transition={{ duration: 0.5, ease: "easeOut" }}
        >
          <h2 className="scroll-mt-28 text-2xl font-bold text-gray-900">通常のChatGPT（GPT-5.2）との違い。速度より思考深度を優先するかで選ぶ</h2>
          <p className="mt-5 text-base leading-8 text-gray-700">
            通常モデル（現在の標準はGPT-5.2。旧標準はGPT-4o）は、短い往復での会話と日常タスクに向いた設計です。一方、推論モデルは「考える時間」を使って難問を処理します。どちらが優れているかではなく、
            ...
            <table className="blog-table w-full min-w-[900px] border-collapse text-left text-sm leading-7 text-gray-700">
              <thead>
                <tr className="border-b border-gray-300">
                  ...
                  <th className="py-3 pl-4 font-semibold text-gray-900">通常モデル（GPT-5.2）</th>
                </tr>
              </thead>
              <tbody>
