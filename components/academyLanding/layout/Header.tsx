                ...
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <a
                            ...
                            className="text-sm font-medium text-[#06C755] hover:text-[#05b54d] transition-colors flex items-center gap-1"
                        >
                        ...
                        <Link
                            href="/briefing"
                            className="px-6 py-2.5 text-sm font-bold text-white bg-orange-500 hover:bg-orange-600 rounded transition-colors shadow-sm"
                        >
                            無料説明会に参加
                        </Link>
                    </nav>
                ...
                <div className="fixed inset-0 z-[60] bg-white md:hidden pt-20 px-6">
                    <nav className="flex flex-col gap-6">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mt-4 px-6 py-3 text-base font-bold text-white bg-[#06C755] hover:bg-[#05b54d] rounded text-center transition-colors flex items-center justify-center gap-2"
                            onClick={() => setIsMobileMenuOpen(false)}
                        >
                        ...
                        <Link
                            href="/briefing"
                            className="px-6 py-3 text-base font-bold text-white bg-orange-500 hover:bg-orange-600 rounded text-center transition-colors"
                            onClick={() => setIsMobileMenuOpen(false)}
                        >
                            無料説明会に参加
                        </Link>
